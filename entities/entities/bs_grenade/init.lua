...
*/
		...
		if self.Mode then
			util.SpriteTrail( self, 0, Color(105, 105, 105, 155), false, 2, 10, 1, 5 / ((2 + 10) * 0.5), "trails/smoke.vmt" )
		else
...
function ENT:Explode()
	...
	if !self.Mode then
		...
		util.BlastDamage( self, self.Owner, self:GetPos(), 250, 110 )
		self:EmitSound( "ambient/explosions/explode_5.wav", 90, math.random( 160, 170 ), 0.8 )
	end
